...
<head>
    ...
    <script type="text/javascript">
        ...
        function validateForm(){
            if($("#scname").val()==""){
                art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'填写学校', ok:true,});
                return false;
            }
            return true;
        }
...
<form id="submitForm" name="submitForm" method="post">
    <div id="container">
        <div id="nav_links">
            当前位置：学校管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增学校</span>
            <div id="page_close">
        ...
        <div class="ui_content">
            <table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    <td class="ui_text_rt">学校</td>
                    <td class="ui_text_lt">
                        <input type="text" id="scname" name="scname"  class="ui_input_txt02"/>
                    </td>
                </tr>
